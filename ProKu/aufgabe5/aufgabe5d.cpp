...
int main() {
    ...
    // Initialisiere beide Zeiger zunaechst
    ...
    for (int k(1); k < n; ++k) {
        // Rufe 'minimax' auf, um  'p_min' bzw. 'p_max' auf 'a[k]'
        // zeigen zu lassen, falls a[k] kleiner bzw. groesser ist:
    ...
    for (int k(0); k < n; ++k) {
        ...
        // dann markiere das auf der Konsole:
        if (&a[k] == p_min) {
            std::cout << " <-- Minimum!";
        }
