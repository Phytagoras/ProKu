...
int main() {
    // Berechnet die Summe mit der Funktion berechneSumme1 und speichert das
    // Ergebnis in summeX
    double summeX = berechneSumme1();

    // Berechnet die Summe erneut mit der Funktion berechneSumme1 und speichert
    // das Ergebnis in summeY
    ...
    std::cout << "x == y: " << ((summeX == summeY) ? "wahr" : "falsch")
              << std::endl;
...
double berechneSumme1() {
    double summe =
        0.0;  // Initialisierung einer Variablen zur Speicherung der Summe
    for (int i = 0; i < 8; i++) {
...
// Funktion zur Berechnung der Summe von 10 Termen, jeder mit dem Wert 1.0
// / 10.0
double berechneSumme2() {
    double summe =
        0.0;  // Initialisierung einer Variablen zur Speicherung der Summe
